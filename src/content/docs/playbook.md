...
Everything we learned the hard way. This document has lasting value long after the gear is bought. For the shopping list, see **The Checklist**. For product reviews, see **The Product Guide**.

> **How to use this:** Read this before the baby arrives. Re-read it in the first week. The advice here would have saved us multiple pediatrician calls, several sleepless nights, and one scary weight-loss episode.

---

## Don't Rely on "Experts" or Past Experience

People with kids will confidently tell you how things work based on what they went through. Their experience is real, but every baby is different. Take advice as input, not instruction. The most confident advice tends to come from the people closest to you — the ones who've raised kids before and remember it well. That confidence is exactly what makes it hard to push back.

Here's where it cost us:

### Story: "He has a stomach ache."
...
### Story: "He doesn't want to sleep — he's been sleeping all day."
...
**The fix:** Follow the 90-minute rule (see [Sleep](#sleep) below).

### Story: "Just feel the bottle" / "Milk warmers are fine."
...
### Story: "I know how to change a diaper."
...
**The fix:** Ask the nurses at the hospital to walk you through it before discharge. [Pampers has a step-by-step guide](https://www.pampers.com/en-us/baby/diapering/article/how-to-change-a-diaper) with videos covering newborns, boys, girls, and toddlers. Don't be embarrassed. Everyone gets it wrong at first.

### Story: "His head will be flat."
...
**The fix:** If you're worried about head shape, talk to your pediatrician at your monthly visit. Don't put anything in the crib.

### Story: "Babies need to get used to noise."
...
**Feeding is the single most important thing you do.** Everything else — sleep, mood, growth, digestion — depends on baby getting the right amount of food at the right intervals. If feeding isn't going well, nothing else will either. Take it seriously from day one.
...
**Example:** 10 lb baby × 2.5 = 25 oz/day. If feeding every 3 hours (8 feeds), that's about 3 oz per feed.

**Never exceed 32 oz per day** — check with your pediatrician if baby seems to want more.

### Track the Hours Between Feeds
...
- The bottle surface is always warmer than the milk inside. What you feel on the outside tells you nothing about what baby is swallowing.
...
### Avoid Oils on Baby's Skin

No ghee, no coconut oil, no seed oils. People will suggest them. Don't. Use only products your pediatrician recommends — CeraVe or Aquaphor are safe choices.

---

## Bottles & Nipples

If baby is fussy, gassy, or crying for long stretches after feeds — it's almost always air. Air gets in from the wrong nipple flow rate, the wrong bottle, or not burping enough. Get the nipple flow right, use anti-colic bottles, and burp baby during and after every feed — not just at the end. These three things together prevent most colic issues.

**This is one of the most common problems new parents face and one of the easiest to fix.** Don't wait weeks wondering why baby is fussy — check the bottle, nipple, and burping routine first.
...
### Use the Right Nipple Flow Rate

Philips Avent Natural Response nipples come in 5 flow rates (1 through 5). The key:
...
[Philips guide on choosing the right nipple](https://www.usa.philips.com/c-f/XC000017498/which-natural-response-nipple-suits-my-baby-best)

### Burp During and After Feeds

Don't wait until the bottle is finished. Pause halfway through, burp, then continue. If baby is squirming or pulling off the bottle, they probably need to burp. Hold baby upright against your shoulder and pat gently. Some babies need 5 minutes of patience before they'll burp — don't give up after 30 seconds.
...
People will tell you to get baby "used to noise." Don't. They don't need to be familiarized with sound — they need peace and quiet to sleep. Invest in real blackout shades, not the cheap stick-on kind. Keep temperature consistent at 68–72°F.
...
A crib maker is not going to risk a wrongful death verdict by being overly cautious. If they say bare mattress and fitted sheet only, that's what it should be. People will say the approved sheets are overpriced. Spend the money anyway — there are better places to save.
...
- [How Much Sleep Do Babies Need](https://www.sleepfoundation.org/children-and-sleep) — Sleep Foundation's guide with age-by-age recommendations
- [Newborn Sleep Patterns](https://www.hopkinsmedicine.org/health/conditions-and-diseases/staying-healthy-during-pregnancy/newborn-sleep-patterns) — Johns Hopkins on what to expect
- [Wake Windows by Age](https://huckleberrycare.com/blog/wake-windows-by-age) — Huckleberry's guide to how long baby should be awake between naps

---

## Air Quality

**Monitor it. Respond to it.** We noticed the air quality monitor turning red in the nursery — VOCs spiking. Turns out it was from diaper changes. The chemicals in wipes, creams, and dirty diapers release VOCs that linger in a closed room. Now we run the air purifier on auto mode so it ramps up when it detects a spike, and we ventilate after changes when possible.
...
People told us to. We didn't, and we're glad. Most are just cabinet furniture — some are less safe than a sturdy dresser or desk. We repurposed a height-adjustable desk and placed the Keekaroo Peanut on top. The height adjusts to whoever is doing the change, it's sturdier than a purpose-built changing table, and when diaper duty is over you still have a desk.

### Baby Brezza Bottle Washer Pro ($260) — skip it.

We bought it. It washes, sterilizes, and dries bottles and pump parts automatically. The cleaning is good. But it's too small — only fits 4 bottles at a time — and a full cycle takes a while. If you're running it 3–4 times a day, you're constantly loading and unloading. For the price, we expected more capacity. A regular dishwasher with a bottle basket works just as well for most loads.

### Spectra Synergy Gold Portable — don't buy the portable version.

It lacks control over suction strength — you get preset levels instead of being able to fine-tune it. The non-portable Synergy Gold lets you adjust each side independently with full control. The portable sounds convenient, but the tradeoff in functionality isn't worth it. Get the standard Synergy Gold and the eufy wearable for when you actually need to move around.
